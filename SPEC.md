...
- **/analyze (23 ส.ค. 2026 — เจ้าของเท่านั้น):** หน้าวิเคราะห์ล็อกอิน role admin,
  noindex — action=stats คำนวณฝั่ง worker จาก bookings ทั้งหมด: occupancy รายเดือน
  15 เดือน (เทียบความจุปัจจุบัน 17 หลัง), คืนขายรายวันสัปดาห์/รายห้อง (12 เดือน),
  lead time 6 ช่วง, จำนวนคืนต่อครั้ง, ลูกค้าซ้ำจากเบอร์ (top 12) — ตัวชี้วัดหลัก =
  คืนขาย (แม่น 100%) ไม่แสดงรายได้จนกว่าจะเก็บราคาจ่ายจริง / เข้าจากปุ่ม 📊 บน /admin
