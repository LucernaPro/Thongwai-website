...
- **หน้า detail เฮือนล้ำลวย R6 (23 ส.ค. 2026):** /rooms/lamluay/ ครบ 3 ภาษา
  ...
  รูป: lamluay-hero (ห้องนอน ผนังไม้ไผ่สานเข้ม), lamluay-bath (แนวตั้ง เก็บสัดส่วนเดิม)
  ⏳ ค้าง: รูประเบียงหน้าบ้าน + ห้องน้ำอีกมุม — Pist ส่งมาแต่ชื่อไฟล์ชนกัน
  (FullSizeRender.jpeg ซ้ำ 3 ไฟล์ เหลือถึงเซิร์ฟเวอร์ใบเดียว) ต้องส่งใหม่ทีละใบ
