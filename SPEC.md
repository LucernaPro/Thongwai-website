...
13. **มาตรฐานช่องไฟ (20 ส.ค. 2026 — Pist: ห้ามเว้นตามใจ ยึดตัวเลขนี้เท่านั้น):**
    ...
    - **section ติดกันที่พื้นหลังโทนเดียวกันหรือใกล้กัน (cream↔cream, cream↔white #fffdf8):
      section ตัวหลัง padding-top:0** — ให้มีช่องเดียว ห้ามซ้อนสองชั้น
      (สีต่างชัด เช่น dusk↔cream ค่อยใช้ padding ปกติ เพราะแถบสีทำหน้าที่คั่นเอง)
    ...
    - จุดที่บังคับใช้แล้ว: #resort-gallery, #reviews, #visit → padding-top:0
